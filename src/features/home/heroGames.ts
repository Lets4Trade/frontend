 ...
 *
 * ⚠️ `character` aponta para arquivos que o export do Figma devolveu VAZIOS
 * (2867 bytes, 683×1024 totalmente transparentes — os cinco idênticos). Os
 * slots estão com a geometria correta: basta substituir os PNGs.
...
export const HERO_GAMES: HeroGame[] = [
  {
    ...
    character: "/images/games/char-1.png",
  ...
  },
  {
    ...
    character: "/images/games/char-2.png",
  ...
  },
  {
    key: "game-3",
    name: "Diablo IV",
    character: "/images/games/char-3.png",
  ...
  },
  {
    key: "game-4",
    name: "Last Epoch",
    character: "/images/games/char-4.png",
  ...
  },
  {
    key: "game-5",
    name: "Albion Online",
    character: "/images/games/char-5.png",
